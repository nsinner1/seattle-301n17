...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: rando was called outside of the function and with var it has to be within the function. Had to change some var to let in for loops. 
  console.log(viewed);
